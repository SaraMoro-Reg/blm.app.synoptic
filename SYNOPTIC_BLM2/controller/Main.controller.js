...
sap.ui.define([
    ...
    return Controller.extend("synoptic.controller.Main", {
        ...
        sendData: function (Transaction, route, Input) {
            var results;
            var transactionCall = "ADIGE7/SYNOPTIC_BLM2/" + route + "/" + Transaction;
       ...
       callBackend: function (Transaction, route, Input) {
        ...
        sessionKeepAlive: function () {
            ...
            controller.getDataSync("SEESSIONKEEPALIVE", "ADIGE7/SYNOPTIC_BLM2/TRANSACTION", input, controller.sessionKeepAliveSuccess, controller.sessionKeepAliveSuccess);
        },
